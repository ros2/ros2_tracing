...
class TestPubSub(TraceTestCase):
    ...
    def __init__(self, *args) -> None:
        super().__init__(
            *args,
            ...
            nodes=['test_ping', 'test_publisher', 'test_message_link_periodic_async'],
        )
    ...
    def test_all(self):
        ...
        # The test_message_link_periodic_async node subscribes to /ping and /the_topic,
        # and publishes to /pong periodically. It annotates this relationship  between
