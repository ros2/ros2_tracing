...
DEFAULT_EVENTS_ROS = [
    ...
    tracepoints.rmw_buffer_publish_route,
    tracepoints.rmw_buffer_publish,
    ...
    tracepoints.rmw_buffer_take,
    tracepoints.rmw_buffer_endpoint_init,
    tracepoints.rmw_buffer_endpoint_discovered,
    ...
    tracepoints.rosidl_buffer_serialize,
    tracepoints.rosidl_buffer_deserialize,
    tracepoints.rosidl_buffer_backend_op,
