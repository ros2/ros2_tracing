...
__attribute__((deprecated("use tracetools::detail::demangle_symbol")))
inline const char * _demangle_symbol(const char * mangled)
{
  return tracetools::detail::demangle_symbol(mangled);
}

__attribute__((deprecated("use tracetools::detail::get_symbol_funcptr")))
...
template<typename T, typename ... U>
__attribute__((deprecated("use tracetools::get_symbol")))
const char * get_symbol(std::function<T(U...)> f)
{
